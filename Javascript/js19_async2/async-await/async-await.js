...
//!https://newsapi.org/v2/top-headlines?country=us&apiKey=6e8cc39fd87548768283600a58e926c2
let isError = false;
const getNews = async function () {
  const API_KEY = "6e8cc39fd87548768283600a58e926c2";
  const url =
...
const renderNews = (news) => {
  ...
  news.forEach((item) => {
    console.log(item);
    const { title, description, urlToImage, url } = item; //!detruction
    newsList.innerHTML += `
